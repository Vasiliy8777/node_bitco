...
public final class Opcode {
     ...
     * 0x01..0x4b:
     *
     * opcode itself is the number of bytes
     * immediately pushed onto the stack.
     */
    public static final int OP_DATA_MIN = 0x01;
    public static final int OP_DATA_MAX = 0x4b;
    ...
    public static boolean isDirectPush(int opcode) {
        return opcode >= OP_DATA_MIN
                && opcode <= OP_DATA_MAX;
    }

    public static boolean isSmallInteger(int opcode) {
        return opcode >= OP_1
                && opcode <= OP_16;
    }
}